          ...
          >
            {messages.map((msg, idx) => (
              ...
              >
                ...
                >
                  <div className="prose prose-sm max-w-none prose-p:leading-relaxed prose-headings:font-serif prose-emerald">
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-stone-100 p-4 rounded-3xl rounded-tl-none flex items-center gap-3 text-emerald-600">
          ...
          <div className="p-6 border-t border-stone-100">
            ...
            >
              <input
                ...
                className="flex-1 bg-stone-50 border-stone-200 rounded-2xl px-6 py-4 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all"
              />
              <button
                type="submit"
